...
<div class="space-y-6 max-w-4xl mx-auto">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Create New Field</h1>
            <p class="text-gray-500">Fill in the information below to add a new pitch to your facility.</p>
        </div>
    </div>

    <div class="border-0 shadow-sm rounded-2xl bg-white overflow-hidden">
        <div class="p-8">
            @include('admin.fields.partials.form')
        </div>
    </div>
</div>
@endsection