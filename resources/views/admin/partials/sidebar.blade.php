    ...
    <div class="h-20 flex items-center justify-between px-6 border-b border-gray-50">
        <a href="/admin/dashboard" class="flex items-center gap-3 group">
            <div class="w-10 h-10 rounded-xl flex items-center justify-center">
                <img class='rounded' src="https://pub-bd8291a7790f4b588b9daf7b1db26e25.r2.dev/app-image/ChatGPT%20Image%20Apr%2026%2C%202026%2C%2002_47_10%20PM.png" alt="QuickField">
            </div>
